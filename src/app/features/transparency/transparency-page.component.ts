          ...
          <dl class="mt-7 grid gap-4 rounded-2xl bg-[var(--color-surface)] p-4 md:grid-cols-[1fr_auto] md:items-end">
            ...
            <div class="md:min-w-56">
              <a
                ...
                class="inline-flex min-h-11 w-full items-center justify-center gap-3 rounded-full bg-[#FFE600] px-5 py-3 text-sm font-black text-[#2D3277] shadow-sm transition hover:bg-[#FFF159]"
              >
