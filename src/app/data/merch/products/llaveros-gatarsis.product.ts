...
export const LLAVEROS_GATARSIS_PRODUCT = {
  ...
  tagline: 'Cada pequeño gesto, una gran diferencia.',
  description:
    'Llaveros Gatarsis en distintos diseños y colores para llevar la causa con vos y ayudar a sostener los rescates.',
  coverImage: {
